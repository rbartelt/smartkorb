...
@AndroidEntryPoint
public class ShowKoerbeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_koerbe);
        ...
        buttonAddKorb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowKoerbeActivity.this, AddKorbActivity.class);
